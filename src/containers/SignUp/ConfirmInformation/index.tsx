...
import { actions_buttons, confirmRowItems, check_email } from './style.module.css';
...
export const ConfirmInformation: FC = () => {
  ...
  return (
    <div className={form}>
      ...
      {status === 'NOT_VERIFIED' ?
        <div className={check_email}>Check your email address to proceed with verification.</div>
        :
        <>
          <div className={confirmRowItems}>
            ...
            <ConfirmRow rowName='Personal Details' confirm={confirmData?.isProfileComplete} />
            <ConfirmRow rowName='Payment Details' confirm={confirmData?.isWalletComplete} />
          </div>
