...
export const validate = (
  ...
  if (is.empty(formState.totalNumberOfDependens))
    errorObject.totalNumberOfDependens = 'Field is required and should contain only digits';

  if (is.empty(formState.businessDescription))
    errorObject.businessDescription = 'Field is required ';

  if (is.empty(formState.jobTitle))
    errorObject.jobTitle = 'Field is required ';
